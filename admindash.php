...
$q="select count('patient_id') as 'tp' from patient";
$res=mysqli_query($conn,$q);
$row=mysqli_fetch_assoc($res);
$q1="select count('Doc_id') as 'tdd' from doctor";
$res1=mysqli_query($conn,$q1);
$row1=mysqli_fetch_assoc($res1);
$q2="select count('id') as 'tn' from nurses";
$res2=mysqli_query($conn,$q2);
$row2=mysqli_fetch_assoc($res2);
$q3="SELECT * FROM `patient` ORDER BY `patient_id` ASC";
