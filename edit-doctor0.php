...
include 'includes/connection.php';
	if (isset($_GET['edit'])) {
        ...
        $_SESSION['id'] = $id;
		$update = true;
		$record = mysqli_query($conn, "SELECT * FROM `doctor` WHERE `Doc_id`=$id");
                            ...
                            <div class="row">
                               ...
                               <!--<div class="col-sm-6">
                                    ...
                                    <div class="form-group gender-select">
                                        ...
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
												<input type="radio" name="gender"  value="<?php echo $row['Gender'] ?>" class="form-check-input" checked>Male
											</label>
                                        </div>
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
												<input type="radio" name="gender"  value="<?php echo $row['Gender'] ?>" class="form-check-input">Female
											</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-lg-3">
                                            <div class="form-group">
                                                <label>Age</label>
                                                <input type="text" name = "age" id = "salary" class="form-control "  value="<?php echo $row['Age'] ?>">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text"  value="<?php echo $row['specialist'] ?>" class="form-control " name="specialist">
