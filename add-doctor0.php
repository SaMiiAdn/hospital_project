                        ...
                        <form action = "insertdoc0.php" name="myForm" onsubmit="return validateForm() && display()" method = "post">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Age</label>
                                        <input class="form-control" name="age" id="num" type="text" oninvalid="alert('Please fill the contact number!');" required>
                                    </div>
                                </div>
                            </div>
                               <!--- <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name = "specialist" id = "salary" class="form-control " oninvalid="alert('Please fill the salary!');" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-3">
                                            <div class="form-group">
                                                <label>Status</label>
                                                <input type="text" name = "status" id = "salary" class="form-control " oninvalid="alert('Please fill the salary!');" required>
                                            </div>
                                        </div>
