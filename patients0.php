...
//SELECT * FROM `patient` WHERE `patient_id``Name``Age``Gender``Address``Disease`
$db= $conn;
    $tableName = "patient";
    $columns = ['patient_id','Name','Age','Gender','Address','Disease','Contact_number','payment_status','room_no'];
    ...
    function fetch_data($db, $tableName, $columns)
    {
        ...
        elseif(empty($tableName)) {
            ...
            $query = "SELECT ".$columnName." FROM $tableName"." ORDER BY patient_id DESC";
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <?php
                    ...
                    <td><a class="dropdown-item" href="edit-patient0.php?edit=<?php echo $data['patient_id']; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a></td>
                    <td>
                    <a href="updatepatient0.php?del=<?php echo $data['patient_id']; ?>" data-dismiss="modal"><div class="m-t-20"><button type="submit" class="btn btn-danger">Delete</button></div></a>
                    </td>
