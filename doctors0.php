...
$db= $conn;
    $tableName = "doctor";
    $columns = ['Doc_id','Name','Age','Gender','Address','salary','status'];
    ...
    function fetch_data($db, $tableName, $columns)
    {
        ...
        elseif(empty($tableName)) {
            ...
            $query = "SELECT ".$columnName." FROM $tableName"." ORDER BY Doc_id DESC";
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <?php
                    ...
                    <td><a class="dropdown-item" href="edit-doctor0.php?edit=<?php echo $data['Doc_id']; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a></td>
                    <td>
                    <a href="updatedoc0.php?del=<?php echo $data['Doc_id']; ?>" data-dismiss="modal"><div class="m-t-20"><button type="submit" class="btn btn-danger">Delete</button></div></a>
                    </td>
                    </tr>
                    <?php
                    $sn++;}}else{ ?>
