                              ...
                              <!---  <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name = "department" id = "salary" class="form-control " oninvalid="alert('Please fill the salary!');" required>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="contact" id="num" type="text" oninvalid="alert('Please fill the contact number!');" required>
                                    </div>
                                </div>
                            </div>
