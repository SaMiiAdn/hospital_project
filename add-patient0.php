        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                ...
                <ul>
                        ...
                        <li class="submenu">
                            <a href="#"><i class="fa fa-book"></i> <span> rooms </span> <span class="menu-arrow"></span></a>
                        ...
                        <form action="insertpatient0.php" name="myForm" method = "post" onsubmit="return display()">
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label> Disease </label>
                                        <input class="form-control" type="text" name="disease" id="diagnosis" oninvalid="alert('Please fill the current diagnosis!');" required>
                                    </div>
                                </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="num" id="num" type="number" oninvalid="alert('Please fill the contact number!');" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Room No </label>
                                        <input class="form-control" name="room" id="num" type="number" oninvalid="alert('Please fill the contact number!');" required>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="payment" id="patient_active" value="Paid">
                                    <label class="form-check-label" for="patient_active">
									Paid
									</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="payment" id="patient_inactive" value="Pending">
                               ...
                               <!--- <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="payment" id="med_record" oninvalid="alert('Please fill the medical record!');" required>
                                    </div>
                                </div>-->
