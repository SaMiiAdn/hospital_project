...
include 'includes/connection.php';
	if (isset($_GET['edit'])) {
        ...
        $_SESSION['id'] = $id;
		$update = true;
		$record = mysqli_query($conn, "SELECT * FROM nurses WHERE id=$id");
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="email" name="username" value="<?php echo $row['email'] ?>">
                                    </div>
                                </div>
                                <!--<div class="col-sm-6">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group gender-select">
                                        ...
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
												<input type="radio" name="gender" class="form-check-input" value="<?php echo $row['gender'] ?>" checked>Male
											</label>
                                        </div>
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
												<input type="radio" name="gender" class="form-check-input" value="<?php echo $row['gender'] ?>">Female
											</label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <select name="shift" class="form-control select">
													<option value="<?php echo $row['shift'] ?>">M</option>
													<option value="<?php echo $row['shift'] ?>">N</option>
												</select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name = "department" id = "salary" class="form-control " value="<?php echo $row['department'] ?>">
                                            </div>
                                        </div>
                                                                            </div>
                                </div>
